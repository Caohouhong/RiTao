...
+(NSDictionary *)mj_objectClassInArray
{
    return @{@"SaleProductPictureCollection":[ModelSaleProductPictureCollection class],
             ...
             @"SaleProductDetailPictureCollection":[ModelSaleProductDetailPictureCollection class],
             @"SaleProductCollection":[ModelSaleProductDetail class]};
}
...
@implementation ModelMemberPrice
...
@implementation ModelSaleProductDetailPictureCollection
