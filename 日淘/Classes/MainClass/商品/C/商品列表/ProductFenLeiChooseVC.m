...
#import "ProductFenLeiChooseCell.h"

static NSString *const productFenLeiChooseCell = @"ProductFenLeiChooseCell";

@interface ProductFenLeiChooseVC ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation ProductFenLeiChooseVC
...
- (void)drawView
{
    ...
    [collectionView registerClass:[ProductFenLeiChooseCell class] forCellWithReuseIdentifier:productFenLeiChooseCell];
...
- (void)didReset
{
    for (ModelCategoryCollection *model in self.dataArray)
    {
        model.isSelect = NO;
    }
    ...
    if (self.fenLeiChooseBLock)
    {
        NSMutableArray *array = [NSMutableArray array];
        
        self.fenLeiChooseBLock(array);
    }
...
{
    ProductFenLeiChooseCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:productFenLeiChooseCell forIndexPath:indexPath];
    cell.model = self.dataArray[indexPath.row];
    return cell;
    //return  [collectionView dequeueReusableCellWithReuseIdentifier:productFenLeiChooseCell forIndexPath:indexPath];
}

- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ModelCategoryCollection *model = self.dataArray[indexPath.row];
